...
//    MARK: Properties
    ...
    weak var tweetHeaderDelegate: TweetHeaderDelegate?
...
//    MARK: Selectors
    ...
    @objc func showActionSheet() {
        tweetHeaderDelegate?.showActionSheet()
    }
...
//    MARK: Helpers
    ...
    func configureUI() {
        let labelStack = UIStackView(arrangedSubviews: [nameLabel, usernameLabel])
    ...
    func configureMentionHandler() {
        captionLabel.handleMentionTap { mention in
            self.tweetHeaderDelegate?.handleFetchUser(withUsername: mention)
        }
    }
}
